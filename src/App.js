      ...
      <div class="w-full max-w-3xl shadow-lg rounded-lg p-6 bg-white">
        ...
        <div class="mt-2 text-gray-700 text-sm max-h-[300px] overflow-y-auto">
          ...
          <div
            ...
            <img src="./images/cancel.png" class="flex-shrink-0 w-4 h-4 ml-2 cursor-pointer" alt="Cancel" />
          </div>
        ...
        <div class="mt-4 flex justify-between text-xs text-gray-500">
          ...
          <ul class="flex space-x-1 items-center text-xs">
            ...
            <li class="h-3 w-3 border-2 border-yellow-500 md:hover:bg-yellow-500 rounded-full cursor-pointer">
            </li>
          </ul>
        </div>
      </div>
